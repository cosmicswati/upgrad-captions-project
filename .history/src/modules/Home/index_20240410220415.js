...
import {IconHome, IconArtBoard, IconBookmark, IconSend, IconGridDots, IconSetting, IconLogout, IconSearch, IconPlus} from '@tabler/icons-react'
    ...
    <div className='h-screen bg-[#d2cfdf]  flex overflow-hidden'>
        <div className='w-[20%] bg-white flex flex-col'>
            ...
            <div className='h-[55%] flex flex-col justify-evenly pl-12 border-b text-gray-400 text-md font-medium'>
                ...
                <div className='flex cursor-pointer hover:text-[#F00F51]'><span className='mr-4'><IconSetting /></span>Settings</div>        
            </div>
            <div className='h-[15%] pt-10 text-gray-400 text-md font-medium'>
                <div className='ml-12 cursor-pointer flex hover:text-[#F00F51]'> <span className='mr-4'><IconLogout/></span>Log out</div>
            </div>
        </div>
        <div className='w-[60%] overflow-scroll h-full scrollbar-hide'>       
            <div className='bg-white h-[75px] border-l border-r flex justify-evenly items-center pt-4'>
                 <div className='flex justify-center items-center'>
                    ...
                    <Button icon={<IconSearch/>}  className='mb-4 ml-4 bg-[#F00F51] hover:bg-[#de0d4c] '/>
                 </div>
                 <Button icon={<IconPlus/>} label='Create new post'  className='rounded-lg bg-red-400 hover:bg-red-500 mb-4'/>
            </div>
