    ...
    <div className='h-screen bg-[#d2cfdf]  flex overflow-hidden'>
        <div className='w-[20%] bg-white flex flex-col'>
            ...
            <div className='h-[55%] flex flex-col justify-evenly pl-12 border-b text-gray-400 text-md font-medium'>
                ...
                <div className='flex cursor-pointer hover:text-[#F00F51]'><span className='mr-4'><FaBookmark /></span>My Favourite</div>
                <div className='flex cursor-pointer hover:text-[#F00F51]'><span className='mr-4'><FaLocationArrow /></span>Direct</div>
                <div className='flex cursor-pointer hover:text-[#F00F51]'><span className='mr-4'><BsFillGrid3X3GapFill /></span>Status</div>
                <div className='flex cursor-pointer hover:text-[#F00F51]'><span className='mr-4'><IoSettings /></span>Settings</div>        
            </div>
        ...
        <div className='w-[60%] overflow-scroll h-full scrollbar-hide'>       
            ...
            <div className='bg-white w-[60%]  mx-auto mt-32 p-8'>
                ...
                <div className='flex justify-evenly mt-4'>
                <div className='flex cursor-pointer hover:text-[#F00F51]'><span className='mr-4'><IoHome /></span>10.5 Likes</div>
                <div className='flex cursor-pointer hover:text-[#F00F51]'><span className='mr-4'><IoHome /></span>10.5 Comments</div>
                <div className='flex cursor-pointer hover:text-[#F00F51]'><span className='mr-4'><IoHome /></span>10.5 Share</div>
                <div className='flex cursor-pointer hover:text-[#F00F51]'><span className='mr-4'><IoHome /></span>10.5 Saved</div>
