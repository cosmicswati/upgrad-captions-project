...
import {IconArtboard, IconBookmark, IconGridDots, IconHeart, IconHeartOff, IconHome, IconLogout,
IconMessageCircle, IconPlus, IconSearch, IconSend, IconSettings, IconShare } from '@tabler/icons'
  ...
  return (
    <div className='h-screen bg-[#d2cfdf]  flex overflow-hidden'>
        <div className='w-[20%] bg-white flex flex-col'>
            ...
            <div className='h-[50%] flex flex-col justify-evenly pl-12 border-b'>
                    <div>Home</div>
                    <div>Message</div>
                    <div>Trending</div>
                    <div>Profile</div>
