    ...
    <div className='h-screen bg-[#d2cfdf]  flex overflow-hidden'>
        <div className='w-[20%] bg-white flex flex-col'>
            ...
            <div className='h-[55%] flex flex-col justify-evenly pl-12 border-b text-gray-400 text-md font-medium'>
                ...
                <div className='flex cursor-pointer hover:text-[#F00F51]'><span className='mr-4'> <IoHome /></span>Explore</div>
                <div className='flex cursor-pointer hover:text-[#F00F51]'><span className='mr-4'><IoHome />My Favourite</span>Feed</div>
