  ...
  <div className="p-4">
    ...
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="relative rounded-md overflow-hidden">
        {/* Image or video */}
        <img src={postImg2} alt="Story 1" className="w-full h-full object-cover" />
        {/* Story user's profile picture */}
        <div className="absolute bottom-2 left-2">
          <img src={postImg2} alt="User 1" className="w-8 h-8 rounded-full border-2 border-white" />
        </div>
      </div>
