...
const Home = () => {
  return (
    <div className='h-screen bg-[#d2cfdf]  flex overflow-hidden mr-2'>
        <div className='w-[25%] bg-white flex flex-col'>
            <div className='h-[35%] flex justify-center items-center border-b'>
            ...
            <div className='h-[50%] flex flex-col justify-evenly pl-12 border-b text-gray-400 text-md font-medium'>
                {
        ...
        <div className='w-[55%] overflow-scroll h-full scrollbar-hide'>       
            <div className='bg-white h-[75px] border-l border-r flex justify-evenly items-center pt-4 sticky top-0 shadow-lg'>
                 ...
                 <div className= 'flex justify-center items-center' >
                 <Button  label='Create new post'  className='rounded-full bg-red-400 hover:bg-red-500 mb-4'/>
            </div>
            </div>
            {
                [1,2,3,4,5,6].map(() => {
                    return(
                        ...
                        <div className='border-b pb-4 mb-4'>
                            <img src={postImg2} className='rounded-xl' />
  ...
  <div className="p-4">
    ...
    <div className="grid grid-cols-3 gap-2">
      ...
      <div className="relative rounded-md overflow-hidden">
        <img src={postImg2} alt="Highlight 1" className="w-full h-full object-cover" />
        {/* Add any overlay or icon if needed */}
      </div>
      {/* Highlight item 2 */}
      <div className="relative rounded-md overflow-hidden">
        <img src={postImg2} alt="Highlight 2" className="w-full h-full object-cover" />
        {/* Add any overlay or icon if needed */}
      </div>
      {/* Repeat this structure for each highlight */}
    </div>
  </div>
</div>
