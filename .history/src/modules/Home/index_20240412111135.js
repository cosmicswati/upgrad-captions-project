        ...
        <div className='w-[60%] overflow-scroll h-full scrollbar-hide'>       
            <div className='bg-white h-[75px] border-l border-r flex justify-evenly items-center pt-4'>
                 <div className='flex justify-center items-center'>
                    ...
                    <Button icon={<LuSearch />}  className='mb-4 ml-6  h-[30px] rounded-lg bg-red-400 hover:bg-red-500 '/>
                 </div>
                 <Button icon={<FaRegPlusSquare />} label='Create new post'  className='rounded-lg bg-red-400 hover:bg-red-500 mb-4'/>
            </div>
