...
const Form = ({
    isSignInPage: propIsSignInPage = false // Rename the parameter to avoid conflict
}) => {
    const [isSignInPage, setIsSignInPage] = useState(propIsSignInPage); // Use a different name for the state variable
    return (
        <div className='bg-[#d2cfdf] h-screen w-full flex justify-center items-center'>
            <div className='h-[550px] w-[750px] bg-white flex justify-center items-center'>
